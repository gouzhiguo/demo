...
<div class="data-wrap case">
    <div class="data-tool clearfix">
        <div class="pull-left form-inline ">
            <button type="button" class="btn btn-default" data-modal="/user/userEdit" data- data-title="新增用户" data-width="452" data-height="380">
            <span class="glyphicon"></span> 新增用户
            </button>
        </div>
        <div class="pull-right">
            <form class="form-inline" id="formSearch">
                ...
                <input class="form-control wd150" name="Account" type="text" value="">
...
<script type="text/javascript">
    ...
    function doSearch() {
        UI.Pager(".paging", { ajax: { url: '/user/indexQuery' } });
    }
