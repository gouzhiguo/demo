...
(function ($) {
	...
	_view = {
	    ...
	    addRemoveBtn: function (setting, node) {
	        ...
	        var aObj = $$(node, consts.id.A, setting),
			removeStr = "<span class='btncj removecj' id='" + node.tId + consts.id.REMOVE + "' title='" + tools.apply(setting.edit.removeTitle, [setting.treeId, node], setting.edit.removeTitle) + "' treeNode" + consts.id.REMOVE + " style='display:none;'></span>";
