!function ($) {
    ...
    var Autocomplete = function (element, options) {
        ...
        this.listen();
		this.mykeydown=this.options.mykeydown;
    };
  ...
  , updater: function (dataValue, realVal) {
      return dataValue + realVal;
  }
   ...
   * =========================== */
    ...
    $.fn.autocomplete.Constructor = Autocomplete; /* TYPEAHEAD NO CONFLICT
  * =================== */
